...
export class Background {
    ...
    constructor(canvas: HTMLCanvasElement, x: number, y: number, ctx: CanvasRenderingContext2D) {
        this.canvas = canvas;
        this.ctx = ctx;
        this.x = x;
        this.y = y;
    ...
    draw() {
        ...
        this.ctx.drawImage(this.img, this.x + CANVAS_WIDTH, this.y, CANVAS_WIDTH, CANVAS_HEIGHT);
    }
